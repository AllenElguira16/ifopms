...
class Portfolio extends React.Component<any, any>{
  ...
  render(){
    ...
    return (
      <Col tag={"a"} href="#" onClick={ (e: React.MouseEvent<HTMLInputElement>) => this.onClick(portfolio._id, e) } sm={3} className="justify-content-around text-decoration-none">
        ...
        <div className="py-2 d-flex align-items-center">
          <img src={`/uploads/profiles/${portfolio._id}/${portfolio.profile}`} className="rounded-circle img-fluid" style={{ height: 30, width: 30 }} />
